...
Note we add 1 to the loop termination condition because we're dealing with substrings. Example, even though 'leetcode' has length of 8, we have to do 'leetcode'[0:9] if we want to get a substring of the whole string.
"""
